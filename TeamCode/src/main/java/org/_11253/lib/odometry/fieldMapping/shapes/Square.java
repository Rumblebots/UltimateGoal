...
public class Square extends Rectangle {
     ...
     *                        said corner.
     * @param draw            how far, in the X & Y dimensions, the rectangle should be drawn. Note that this
     ...
     */
    public Square(Corners drawCorner, Corners rotateCorner, Coordinate<Double> startingPoint, double draw, double rotationalAngle) {
        super(drawCorner, rotateCorner, startingPoint, draw, draw, rotationalAngle);
    }
}
