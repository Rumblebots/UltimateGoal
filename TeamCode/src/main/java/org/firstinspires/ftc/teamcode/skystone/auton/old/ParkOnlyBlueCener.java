...
@Disabled
@Deprecated
//@Autonomous(name = "ParkOnlyBlueCenter", group = "Auton")
public class ParkOnlyBlueCener extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            while (opModeIsActive()) {
                encoderStrafe(0.3, 24, 24, 4.0);
                motors.resetEncoders();
                encoderDrive(0.3, 0.3, 18, 18, 4.0);
                break;
            }
        }
