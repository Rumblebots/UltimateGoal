...
public class MeccanumTest extends OpMode
{
    ...
    private org.firstinspires.ftc.teamcode.skystone.hardware.v2.Sensors.Sensors Sensors = new Sensors();
    public void init ()
    {
        MotorsDriveReference.init(hardwareMap);
        Sensors.init(hardwareMap);
    }
//    public void addTelem (org.firstinspires.ftc.teamcode.skystone.hardware.v2.Sensors.Sensors.Turn Turn)
//    {
