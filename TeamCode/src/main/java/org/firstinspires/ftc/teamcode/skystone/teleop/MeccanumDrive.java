...
public class MeccanumDrive extends OpMode
{
     ...
     */
    private org.firstinspires.ftc.teamcode.skystone.hardware.v2.Motors_Aux Motors_Aux_Reference = new Motors_Aux();
    private org.firstinspires.ftc.teamcode.skystone.hardware.v2.Motors_Aux.TeleOp Motors_Aux = Motors_Aux_Reference.new TeleOp(); // Access TeleOp controls.

    /*
     * Set up the Motors_Drive interface.
     * This controls all of the functions of the drive motors.
     */
    private org.firstinspires.ftc.teamcode.skystone.hardware.v2.Motors_Drive Motors_Drive_Reference = new Motors_Drive();
    private org.firstinspires.ftc.teamcode.skystone.hardware.v2.Motors_Drive.TeleOp Motors_Drive = Motors_Drive_Reference.new TeleOp(); // Access TeleOp controls.
    private org.firstinspires.ftc.teamcode.skystone.hardware.v2.Motors_Drive.Common Motors_Drive_Common = Motors_Drive_Reference.new Common(); // Access Common controls

    /*
     * Set up the Servos interface.
     * This controls all of the functions of the servos.
     */
    private org.firstinspires.ftc.teamcode.skystone.hardware.v2.Servos Servos_Reference = new Servos();
    private org.firstinspires.ftc.teamcode.skystone.hardware.v2.Servos.TeleOp Servos = Servos_Reference.new TeleOp(); // Access TeleOp controls.
